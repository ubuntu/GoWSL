...
const (
	...
	flag_ENABLE_INTEROP        WslFlags = 0x1 //nolint:revive // flag names mimic'ing Win32.
	flag_APPEND_NT_PATH        WslFlags = 0x2 //nolint:revive // flag names mimic'ing Win32.
	flag_ENABLE_DRIVE_MOUNTING WslFlags = 0x4 //nolint:revive // flag names mimic'ing Win32.
	...
	flag_undocumented_WSL_VERSION WslFlags = 0x8 //nolint:revive // flag names mimic'ing Win32.
)
